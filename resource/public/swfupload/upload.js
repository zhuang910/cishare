...
function swfupload(img_id,input_name,title,isthumb,file_limit,file_types,file_size,moduleid,yesdo,nodo){
		url ='/student/uploads/index?img_id='+img_id+'&input_name='+input_name+'&isthumb='+isthumb+'&file_limit='+file_limit+'&file_types='+file_types+'&file_size='+file_size+'&moduleid='+moduleid+'&s=1';
		pub_alert_html(url);
}
