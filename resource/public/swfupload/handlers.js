...
{ 
	...
	if(ext == 1) {
		...
		var img = '<a href="javascript:void(0);" onclick="javascript:add_file(this,'+id+')" id="on_'+id+'" class="on"><div class="icon"></div><img src="/resource/home/images/dir_icon/all.png" width="80" alt="'+name+'" imgid="'+id+'" path="'+src+'"/></a>';
	}
...
function fileQueued(file) {
	try {
		...
		var progress = new FileProgress(file, this.customSettings.progressTarget);
		progress.setStatus("Waiting for the upload...");
...
function uploadProgress(file, bytesLoaded, bytesTotal) {
	try {
		...
		progress.setStatus("Are uploading, please later...");
	} catch (ex) {
		this.debug(ex);
	}
}
