    ...
    var i = function(t, i) {
        ...
        this.create = function(t) {
            if (!b) {
                ...
                l.hoverReset && this.$element.on("mouseenter.ace_scroll touchstart.ace_scroll",
                function() {
                    o.reset()
                }),
...
function(e, t) {
    ...
    r.prototype.loading = function(t) {
        ...
        this.element.removeAttribute("readonly");
            ...
            0 == n.length && (n = e('<div class="ace-file-overlay"></div>').appendTo(this.$container), n.on("click tap",
            function(e) {
    ...
    var o = function() {
        ...
        function(t) {
            ...
            n === !1 ? !1 : (e.$element.data("ace_input_method", "drop"), e.$element.data("ace_input_files", n), e.show_file_list(n), e.$element.triggerHandler("change", [!0]), !0)
        })
    },
    l = function() {
...
function(e) {
    e.fn.ace_wysiwyg = function(t) {
        ...
        return this.each(function() {
            ...
            t.find(".dropdown-menu input[type=text]").on("click",
            function() {
                return ! 1
            }).on("change",
            function() {
            ...
            t.find("input[type=file]").prev().on(ace.click_event,
            function() {
                e(this).next().click()
            }),
            ...
            var u = e(this),
            f = !1;
            t.find("a[data-view=source]").on("click",
            function(t) {
...
function(e, t) {
    function i(t, i) {
        ...
        s.on("mousewheel.spinner DOMMouseScroll.spinner",
        function(e) {
...
function(e) {
    ...
    e.fn.ace_tree = function(i) {
        ...
        this.each(function() {
            var i = e(this);
            i.html('<div class="tree-folder" style="display:none;">				<div class="tree-folder-header">		<i class="' + ace.vars.icon + t["close-icon"] + '"></i>					<div class="tree-folder-name"></div>	<div class="pull-right action-buttons" id="folder_zyj"></div>			</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item" style="display:none;">				' + (null == t["unselected-icon"] ? "": '<i class="' + ace.vars.icon + t["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>		<div class="pull-right action-buttons" id="item_zyj"></div>		</div>'),
...
function(e) {
    e.fn.ace_wizard = function(t) {
        return this.each(function() {
            ...
            a.$prevBtn.remove(),
            a.$nextBtn.remove(),
            a.$prevBtn = n.find(".btn-prev").eq(0).on(ace.click_event,
            function() {
                a.previous()
            }).attr("disabled", "disabled"),
            a.$nextBtn = n.find(".btn-next").eq(0).on(ace.click_event,
            function() {
                a.next()
            }).removeAttr("disabled"),
