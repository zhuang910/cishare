...
(function(b, d) {
    ...
    c.prototype = {
        ...
        populate: function(g) {
            ...
            e.show();
            this.options.dataSource.data(g.data(),
            function(i) {
                e.hide();
                b.each(i.data,
                function(j, m) {
                    ...
                    if (m.type === "folder") {
						...
						var zyjcolumn = '<a href="javascript:;" onclick="add_column('+m.id+',1)" class="blue"><i class="ace-icon fa fa-plus bigger-130"></i></a>'
						+'<a href="javascript:;" onclick="add_column('+m.id+',2)" class="blue"><i class="ace-icon fa fa-pencil bigger-130"></i>'
						+'</a><a href="javascript:;" onclick="del_column('+m.id+')" class="red"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>';
						
						k.find("#folder_zyj").html(zyjcolumn);
                        ...
                        if (m.type === "item") {
							...
							+'<a href="javascript:;" onclick="add_column('+m.id+',2)" class="blue"><i class="ace-icon fa fa-pencil bigger-130"></i>'
							+'</a><a href="javascript:;" onclick="del_column('+m.id+')" class="red"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>';
							 k.find("#item_zyj").html(zyjcolumn);
                            k.data(m);
