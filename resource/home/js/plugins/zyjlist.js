$(document).ready(function(){
    ...
    function zjj_tab_info(){
        $("dl[data-img='true']").hide();
        $("dl[data-img='true']").eq(curPic).show();
    }
	...
	$("#sLeftBtnB").click(function(){
		if($(this).attr("class")=="sLeftBtnBSel") {
			...
			leftPosition=leftPositionNum+111+"px";
			if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-6)*111;
			if((leftPositionNum+111) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
	...
	$("#sRightBtnB").click(function(){
		if($(this).attr("class")=="sRightBtnBSel"){
			...
			leftPosition=leftPositionNum-111+"px";
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-6)*111;
			if((leftPositionNum-111)==bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
