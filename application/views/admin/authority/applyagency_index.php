...
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/admin/authority/applyagency/index";
		}
		...
		buttons: [ 
			...
			},
			{
				...
				click: function() {
					$( this ).dialog( "close" ); 
					$.ajax({
							url: '/admin/authority/applyagency/upstate?id='+id+'&state='+state,
							type: 'GET',
							dataType: 'json'
						})
						.done(function(r) {
...
function sendemail(id){
	$.ajax({
 		url: '/admin/authority/applyagency/sendemail?id='+id,
 		type: 'GET',
 		dataType: 'json',
 	})
 	.done(function(r) {
...
function save(){
	...
	$.ajax({
		url: '/admin/authority/applyagency/dosendemail',
		type: 'POST',
		dataType: 'json',
		data: data
	})
