	...
	<div class="col-sm-12">
		<div>
			<div class="table-header">
				管理员列表
				<button style="float:right;" onclick="add()" class="btn btn-primary btn-sm btn-default btn-sm" title="添加管理员" type="button">
...
<script type="text/javascript">
	...
	function add(){
		window.location.href='<?=$access_path?>admin/add';
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/admin/authority/admin/index";
		}
...
function del(id){
	pub_alert_confirm('/admin/authority/admin/del?id='+id);
}

function upstate(id,state){
	pub_alert_confirm('/admin/authority/admin/upstate?id='+id+'&state='+state);
	
}

function uppassword(id){
	pub_alert_confirm('/admin/authority/admin/uppassword?id='+id);
