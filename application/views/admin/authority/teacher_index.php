	...
	<div class="col-sm-12">
		<div>
			<div class="table-header">
				...
				<button style="float:right;" onclick="pub_alert_html('<?=$access_path?>teacher/tochanel?s=1')" class="btn btn-primary btn-sm btn-default btn-sm" title="导入" type="button">
					<span class="glyphicon  glyphicon-plus"></span>
					导入
				</button>	
				<a style="float:right;" href="<?=$access_path?>teacher/export" class="btn btn-primary btn-sm btn-default btn-sm" title="导出" type="button">
						<span class="glyphicon  glyphicon-plus"></span>
						导出
				</a>		
			</div>
...
<script type="text/javascript">
	...
	function add(){
		window.location.href='/admin/authority/teacher/add';
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/admin/authority/teacher/index";
		}
...
function del(id){
	pub_alert_confirm('/admin/authority/teacher/del?id='+id);
}

function upstate(id,state){
	pub_alert_confirm('/admin/authority/teacher/upstate?id='+id+'&state='+state);
	
}

function uppassword(id){
	pub_alert_confirm('/admin/authority/teacher/uppassword?id='+id);
