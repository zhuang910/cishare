...
<script type="text/javascript">
	...
	function add(){
		window.location.href='<?=$access_path?>society/add';
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/admin/authority/society/index";
		}
...
function del(id){
	pub_alert_confirm('/admin/authority/society/del?id='+id);
}

function upstate(id,state){
	pub_alert_confirm('/admin/authority/society/upstate?id='+id+'&state='+state);
	
}

function uppassword(id){
	pub_alert_confirm('/admin/authority/society/uppassword?id='+id);
