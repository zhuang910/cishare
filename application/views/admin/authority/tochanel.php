<link rel="stylesheet" href="<?=RES?>admin/css/sdyinc.css" />
									...
									<div class="modal-content">
										<div class="widget-header">
											...
											<div class="widget-toolbar no-border">
												<a class="btn btn-xs bigger btn-danger" href="<?=$access_path?>teacher/tochaneltenplate">
													下载模板
												</a>
											</div>
										</div>
										<div class="widget-body"><div class="widget-body-inner" style="display: block;">
												<div class="widget-main" style="height: 230px">
													<form id="validation-form" method="post" action="<?=$access_path?>teacher/upload_excel">
