...
<script type="text/javascript">
	function add(){
		window.location.href="/admin/authority/group/add";
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/admin/authority/group/index";
		}
...
function del(id){
pub_alert_confirm('/admin/authority/group/del?id='+id);
}

function upstate(id,state){
pub_alert_confirm('/admin/authority/group/upstate?id='+id+'&state='+state);
}
</script>
<!-- end script -->
<script type="text/javascript">
	   function showpower(id){
         	$.ajax({
         		url: '/admin/authority/group/get_power?id='+id,
         		type: 'GET',
         		dataType: 'json',
         	})
         	.done(function(r) {
