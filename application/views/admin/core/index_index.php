...
<div class="row">
	<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-3 center">
									<span class="profile-picture">
										<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" title="点击修改头像" src="<?=!empty($dataadmin->image)?$dataadmin->image:'<?=RES?>/admin/avatars/profile-pic.jpg'?>" />
									</span>

									<div class="space space-4"></div>

									<a href="/admin/authority/personal/profile" class="btn btn-sm btn-block btn-success">
										<i class="ace-icon glyphicon glyphicon-pencil bigger-120"></i>
										<span class="bigger-110">修改资料(Edit Profile)</span>
									</a>

									<a href="/admin/authority/personal/password" class="btn btn-sm btn-block btn-primary">
							...
							<div class="profile-feed row">
								<div class="col-sm-6">
									<div class="profile-activity clearfix">
										<div>
											<img class="pull-left" alt="Alex Doe's avatar" src="<?=RES?>admin/avatars/avatar5.png" />
									...
									<div class="profile-activity clearfix">
										<div>
											<img class="pull-left" alt="Susan Smith's avatar" src="<?=RES?>admin/avatars/avatar1.png" />
									...
									<div class="profile-activity clearfix">
										<div>
											<img class="pull-left" alt="David Palms's avatar" src="<?=RES?>admin/avatars/avatar4.png" />
							...
							<div class="profile-users clearfix">
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar4.png" alt="Bob Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar1.png" alt="Rose Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar.png" alt="Jim Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar5.png" alt="Alex Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar2.png" alt="Phil Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar3.png" alt="Susan Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
											</a>
										</div>
								...
								<div class="itemdiv memberdiv">
									<div class="inline pos-rel">
										<div class="user">
											<a href="#">
												<img src="<?=RES?>admin/avatars/avatar3.png" alt="Alexa Doe's avatar" />
		...
		<script src="<?=RES?>admin/js/x-editable/ace-editable.min.js"></script>
		...
		jQuery(function($) {
			...
			try {//ie8 throws some harmless exceptions, so let's catch'em
				...
				$('#avatar').editable({
					...
					url: function(params) {
						// ***UPDATE AVATAR HERE*** //
						var submit_url = '/admin/authority/personal/editphoto';//please modify submit_url accordingly
						var deferred = null;
						var avatar = '#avatar';
