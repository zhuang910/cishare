...
<?php $this->load->view('admin/public/js_css_kindeditor');?>
...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
			...
			<form class="form-horizontal" id="validation-form" method="post" action="<?=$access_path?>special/save">
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<a href="javascript:swfupload('image_pic','face_pic','文件上传',0,3,'jpeg,jpg,png,gif',3,0,yesdo,nodo)">
								<img id="image_pic"  src="<?=!empty($info->image)?$info->image:'/resource/admin/images/admin_upload_thumb.png'?>" width="135" height="113">
							</a>
						</div>
					</div>
				</div>
...
<?php $this->load->view('admin/public/js_kindeditor_create')?>
		...
		$('#validation-form').validate({
					...
					submitHandler: function (form) {
						...
						.done(function(r) {
							if(r.state==1){
								pub_alert_success();
								window.location.href="/admin/article/special/index";
							}else{
								pub_alert_error();
							}
