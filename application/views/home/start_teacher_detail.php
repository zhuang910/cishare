...
<div class="width_1024 clearfix mg-t-50">
   ...
   <ul>
	...
	<div class="crumbs-nav"><a href="/<?$puri?>"><?=lang('nav_1')?></a><i> / </i><a href="/<?=$puri?>/start_teacher?programaid=<?=$programaid?>"><?=lang('nav_'.$programaid)?></a><i> / </i><span><?=lang('news_detail')?></span></div>
