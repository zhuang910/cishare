      ...
      <form class="form-signin" role="form"  id="myform" name="myform" action="/student/login/ajax_login" method="post">
        ...
        <ul>
          ...
          <li class="mg_20" id="fpassword">
            ...
            <span class="inline-xian"></span>--> 
			<a href="/<?=$puri?>/student/login" target="_blank" class="login-remember"><?=lang('no_email')?>?</a>
&nbsp;			
			<a href="/<?=$puri?>/student/login/fpassword" target="_blank" class="login-remember"><?=lang('forget_password')?>?</a> </li>
          <li>
