	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="widget-header">
				<h5 class="widget-title">成绩数据导入</h5>
				...
				<div class="widget-main">
					...
					<div class="step-content pos-rel" id="step-container">
						<div class="step-pane active" id="step1">
							<form class="form-horizontal" id="conditions" method="post" action="<?=$zjjp?>stuscore/tochaneltenplate">
								...
								<div class="form-group">
									<label for="scoretype" class="col-xs-12 col-sm-3 control-label no-padding-right">考试类型</label>
									<div class="col-xs-12 col-sm-5">
										<select id="scoretype" name="scoretype" aria-required="true" aria-invalid="false" onchange="c()">
											<option value="0">—请选择—</option>
								...
								<div class="form-group">
									<label for="course" class="col-xs-12 col-sm-3 control-label no-padding-right">课程</label>
									<div class="col-xs-12 col-sm-5">
										<select id="course" name="courseid" aria-required="true" aria-invalid="false" onchange="c()">
											<option value="0">—请选择—</option>
										</select>
									</div>
								</div>
						...
						<div class="step-pane" id="step2">
							<div class="widget-body-inner" style="display: block;">
								<div class="widget-main" style="height: 230px">
									<form id="validation-form" method="post" action="<?=$zjjp?>stuscore/upload_excel">
