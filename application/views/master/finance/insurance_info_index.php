...
<style type="text/css">
	...
	body td{width:100px; padding:0px;text-align: center;}
</style>
									...
									<div>                                  
										<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable-ajax basic_major">
                                            ...
                                            <thead>
													...
													<th width="120"><input type="text" id="field_4" placeholder="应缴费用" style="width:90px;"></th>
...
$(function () {
        $("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'/master/finance/insurance_info',
