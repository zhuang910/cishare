...
<style type="text/css">
	...
	body td{width:200px;text-align: center;padding: 0px;}
</style>
									...
									<div>                                  
										<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable-ajax basic_major">
											<thead>
													...
													<th width="120"><input type="text" id="field_4" placeholder="应缴费用" style="width:120px;"></th>
													<th width="120"><input type="text" id="field_5" placeholder="实缴费用" style="width:120px;"></th>
													<th width="120"></th>
													<th width="120"></th>
													</tr>
												</thead>
...
$(function () {
        $("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'/master/finance/bedding_fee',
