...
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/finance/credentials_deposit/index";
		}
...
function end_apply(id,state){
	pub_alert_html('/master/finance/credentials_acc/add_shibai?id='+id+'&type=credentials_deposit');
