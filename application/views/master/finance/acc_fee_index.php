									...
									<div>                                  
										<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable-ajax basic_major">
											<thead>
													...
													<th><input type="text" id="field_1" placeholder="中文名字" style="width:90px;"></th>
													<th width="120"><input type="text" id="field_2" placeholder="英文名字" style="width:90px;"></th>
													<th width="120"><input type="text" id="field_3" placeholder="护照号" style="width:90px;"></th>
													<th width="120"><input type="text" id="field_4" placeholder="天数" style="width:90px;"></th>
													<th width="120"><input type="text" id="field_5" placeholder="总钱数" style="width:90px;"></th>
													<th width="120"></th>
													<th width="120"></th>
													<th width="120"><input type="text" id="field_6" placeholder="时间" style="width:90px;"></th>
													</tr>
												</thead>
											<thead>
												<tr>
...
$(function () {
        $("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'/master/finance/acc_fee',
