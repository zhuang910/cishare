...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-header">
			试题项列表
			<a style="float:right;" href="/master/test/topic/add_paper_item" class="btn btn-primary btn-sm btn-default btn-sm" title="添加书籍" type="button">
...
function add(){
	...
	$('#group').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/test/topic";
		}
...
function del(id){
	pub_alert_confirm('/master/test/topic/del?id='+id);
