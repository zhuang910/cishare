...
function next(){
	...
	$.ajax({
		url: "<?=$zjjp?>teacher_checking/nexttime?starttime="+starttime+"&classtime="+<?=$classtime['classtime']?>+'&studentid='+<?=$studentid?>+'&overtime='+overtime,
		type: 'POST',
		dataType: 'json',
		data: {},
	})
...
function up(){
	...
	$.ajax({
		url: "<?=$zjjp?>teacher_checking/uptime?starttime="+starttime+"&classtime="+<?=$classtime['classtime']?>+'&studentid='+<?=$studentid?>+'&overtime='+overtime,
		type: 'POST',
		dataType: 'json',
		data: {},
	})
...
function changedate(){
	...
	var overtime=$('#overtime').val();
	$.ajax({
		url: "<?=$zjjp?>teacher_checking/changedate?starttime="+starttime+"&classtime="+<?=$classtime['classtime']?>+'&studentid='+<?=$studentid?>+'&overtime='+overtime,
		type: 'POST',
		dataType: 'json',
		data: {},
	})
