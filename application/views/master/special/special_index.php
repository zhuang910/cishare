...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-responsive">
			...
			专题管理
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加" type="button" href="/master/special/special/add" style="float:right;">
...
<script type="text/javascript">
	function del(id){
		pub_alert_confirm('/master/special/special/del?id='+id);
	}
</script>
...
if($('#sample-table-2').length > 0) {
	$("#sample-table-2").dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": '<?=$zjjp?>special/special/index',
