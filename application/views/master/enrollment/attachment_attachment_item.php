					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="/master/enrollment/attachment/attachment_add_item?aTopic_id=<?=$val['aTopic_id']?>" class="btn btn-xs btn-info">编辑</a>
...
<script type="text/javascript">
	...
	function add(){
		...
		window.location.href="/master/enrollment/attachment/attachment_add_item";
	}
</script>
<script type="text/javascript">
// dataTables
if($('.dataTable').length > 0){
	$('.dataTable').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/enrollment/attachment/attachment_item";
		}
...
function del(id){
	pub_alert_confirm('/master/enrollment/attachment/attachment_item_del?aTopic_id='+id);
}
</script>
