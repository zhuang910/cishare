		...
		<div>
			...
			<div class="step-content pos-rel" id="step-container">
				<div class="step-pane active" id="step1">
					<h3 class="lighter block green"><?=!empty($result)?'编辑群组':'添加群组'?>
					<a href="javascript:history.back();" title='返回上一级' class="pull-right ">
						<i class="ace-icon fa fa-reply light-green bigger-130"></i>
					</a>
					</h3>
					<form class="form-horizontal" id="validation-form" method="post" action="/master/enrollment/apply_form/save_group" enctype = 'multipart/form-data'>
					...
					<div class="form-group">
						...
						<input type="hidden" name="pageid" value="<?=!empty($pageid)?$pageid:''?>">
						<input type="hidden" name="groupid" value="<?=!empty($result['tClass_id'])?$result['tClass_id']:''?>">
