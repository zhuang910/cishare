...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
			...
			<form class="form-horizontal" id="validation-form" method="post" action="/master/enrollment/register/saveone">
				...
				<div class="space-2"></div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">学生类别:</label>
					<div class="col-xs-12 col-sm-4">
				...
				<div class="space-2"></div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">202表序号:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
								<input type="text"  id="ordernumber_202" name="ordernumber_202" value="" class="col-xs-12 col-sm-5" />
						</div>
					</div>
				</div>
				<div class="space-2"></div>
				...
				<div class="space-2"></div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">负责老师:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
								<input type="text"  id="dutyteacher" name="dutyteacher" value="" class="col-xs-12 col-sm-5" />
						</div>
					</div>
				</div>
				<div class="space-2"></div>
	...
	$('#validation-form').validate({
					...
					submitHandler: function (form) {
						...
						.done(function(r) {
							if(r.state==1){
								pub_alert_success();
								window.location.href="/master/enrollment/register";
							}else{
								pub_alert_error();
							}
