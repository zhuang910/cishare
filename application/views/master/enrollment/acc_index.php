...
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/enrollment/pickup/acc";
		}
			...
			buttons: [
				{
					...
					click: function() {
						$( this ).dialog( "close" );
						$.ajax({
							url: '/master/enrollment/pickup/del_acc?id='+id,
							type: 'GET',
							dataType: 'json'
						})
						.done(function(r) {
...
function upstate(id,state){
	...
	pub_alert_confirm('/master/enrollment/pickup/upstate_acc?id='+id+'&state='+state);
	// //override dialog's title function to allow for HTML titles
