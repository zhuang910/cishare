									...
									<div class="modal-content">
										<div class="widget-header">
											...
											<div class="widget-toolbar no-border">
												<a class="btn btn-xs bigger btn-danger" href="<?=$zjjp?>acc_dispose_electric/tochaneltenplate">
													下载模板
												</a>
											</div>
										</div>
										<div class="widget-body"><div class="widget-body-inner" style="display: block;">
												<div class="widget-main" style="height: 230px">
													<form id="validation-form" method="post" action="<?=$zjjp?>acc_dispose_electric/upload_excel">
