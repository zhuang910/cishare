...
<div id="pub_edit_bootbox" class="modal fade" tabindex="-1">
					<div class="modal-dialog">
									<div class="modal-content">
										...
										<form id="pub_form" class="form-horizontal" id="validation-form" method="post" action="/master/enrollment/process/edit_app_remark_info" >
...
function save(){
	...
	$.ajax({
		...
		url: '/master/enrollment/process/edit_app_remark_info',
		type: 'POST',
		dataType: 'json',
		data: data
	})
