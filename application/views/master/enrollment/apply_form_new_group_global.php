		...
		<div>
			...
			<div class="step-content pos-rel" id="step-container">
				<div class="step-pane active" id="step1">
					<h3 class="lighter block green"><h3>添加已有群组</h3>
					<a href="javascript:history.back();" title='返回上一级' class="pull-right ">
						<i class="ace-icon fa fa-reply light-green bigger-130"></i>
					</a>
					</h3>
					<form class="form-horizontal" id="validation-form" method="post" action="/master/enrollment/apply_form/save_page_group" enctype = 'multipart/form-data'>
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">群组名称:</label>

							<div class="col-xs-12 col-sm-4">
								<div class="clearfix">
									<select name='group' id="group" onchange="get_group()">
...
<script type="text/javascript">
	function get_group () {
		...
		$.ajax({
			type:'GET',
			url:'/master/enrollment/apply_form/get_group?id='+group,
			success:function(r){
				if(r.state == 1){
						$('#zyj').html();
						$('#zyj').html(r.data);
