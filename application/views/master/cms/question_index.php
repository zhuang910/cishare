...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-responsive">
			...
			常见问题管理
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加" type="button" href="/master/cms/question/add" style="float:right;">
...
<script type="text/javascript">
	function del(id){
		pub_alert_confirm('/master/cms/question/del?id='+id);
	}
</script>
<script type="text/javascript">
	function edit_state(id,state){
		pub_alert_confirm('/master/cms/question/edit_state?id='+id+'&state='+state);
	}
</script>
<script type="text/javascript">
$(function(){
if($('#sample-table-2').length > 0){
	$("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'<?=$zjjp?>question/index',
