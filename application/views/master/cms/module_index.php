...
function add(){
		window.location.href="<?=$zjjp?>module/add";
	}
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("basic_major")){
			...
			opt.aoColumnDefs = [{ "bSortable": false, "aTargets": [ 7 ] }];
		}
...
function del(id){
	pub_alert_confirm('/master/cms/module/del?id='+id);
