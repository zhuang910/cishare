...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
			...
			<form class="form-horizontal" id="validation-form" method="post" action="/master/cms/question/save">
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">问题标题:</label>
				...
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">答案:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
								<textarea style="width: 434px; height: 173px;" name="content" id="content"><?=!empty($info->content) ? $info->content : ''?> </textarea>
