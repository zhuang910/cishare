...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-responsive">
			...
			服务和项目
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加图集" type="button" href="/master/cms/server/addgallery?columnid=<?=$columnid?>&_id=<?=$_id?>" style="float:right;">
...
<script type="text/javascript">
	function del(columnid,id){
		pub_alert_confirm('/master/cms/server/del_image?columnid='+columnid+'&id='+id);
	}
</script>
<script type="text/javascript">
	function edit_state(columnid,id,state){
		pub_alert_confirm('/master/cms/server/edit_state_image?columnid='+columnid+'&id='+id+'&state='+state);
	}
</script>
<script type="text/javascript">
$(function(){
if($('#sample-table-2').length > 0){
	$("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'<?=$zjjp?>server/edit_image?columnid=<?=$columnid?>&_id=<?=$_id?>',
