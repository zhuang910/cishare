...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
			...
			<form class="form-horizontal" id="validation-form" method="post" action="<?=$zjjp?>article/save">
				...
				<div class="space-2"></div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">来源:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
								<input type="text"  id="source" name="source" value="<?=!empty($info->source) ? $info->source : ''?>" class="col-xs-12 col-sm-5" />
						</div>
					</div>
				</div>
				<div class="space-2"></div>
	...
	$('#validation-form').validate({
					...
					submitHandler: function (form) {
						...
						.done(function(r) {
							if(r.state==1){
								pub_alert_success();
								window.location.href="/master/cms/article?columnid=<?=$columnid?>";
							}else{
								pub_alert_error();
							}
