...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-responsive">
			...
			<?=$bread_1?>
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加PPT" type="button" href="/master/cms/ppt/addppt?columnid=<?=$columnid?>" style="float:right;">
...
<script type="text/javascript">
	function del(columnid,id){
		pub_alert_confirm('/master/cms/ppt/del?columnid='+columnid+'&id='+id);
	}
</script>
<script type="text/javascript">
	function edit_state(columnid,id,state){
		pub_alert_confirm('/master/cms/ppt/edit_state?columnid='+columnid+'&id='+id+'&state='+state);
	}
</script>
<script type="text/javascript">
$(function(){
if($('#sample-table-2').length > 0){
	$("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'<?=$zjjp?>ppt/index?columnid=<?=$columnid?>',
