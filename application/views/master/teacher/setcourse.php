...
function up(page){
	if(page==0){
		...
		$.ajax({
			url: "<?=$zjjp?>teacher_course/up_course?page="+page+"&teacherid="+<?=$teacherid?>,
			type: 'POST',
			dataType: 'json',
			data: data,
		})
...
function next(page){
		...
		var data=$('#search').serialize();
		$.ajax({
			url: "<?=$zjjp?>teacher_course/next_course?page="+page+"&teacherid="+<?=$teacherid?>,
			type: 'POST',
			dataType: 'json',
			data: data,
		})
...
function search_course(){
	var data=$('#search').serialize();
	$.ajax({
		url: "<?=$zjjp?>teacher_course/get_search_course?teacherid="+<?=$teacherid?>,
		type: 'POST',
		dataType: 'json',
		data: data,
	})
...
function refresh(){
	window.location.href="/master/teacher/teacher_course?teacherid=<?=$teacherid?>";
}
</script>