		...
		<div>
			...
			<div class="step-content pos-rel" id="step-container">
				<div class="step-pane active" id="step1">
					...
					<form class="form-horizontal" id="validation-form" method="post" action="/master/authority/personal/saveprofile" enctype = 'multipart/form-data'>
...
$(document).ready(function(){
	$('#validation-form').validate({
					...
					rules: {
						...
						email: {
							required: true,
							remote:'/master/authority/personal/checkemail?id=<?=!empty($info->id)?$info->id:''?>'
						},
						mobile: {
							required: true
						},
