...
<script type="text/javascript">
	...
	function add(){
		window.location.href='<?=$zjjp?>admin/add';
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/authority/admin/index";
		}
...
function del(id){
	pub_alert_confirm('/master/authority/admin/del?id='+id);
}

function upstate(id,state){
	pub_alert_confirm('/master/authority/admin/upstate?id='+id+'&state='+state);
	
}

function uppassword(id){
	pub_alert_confirm('/master/authority/admin/uppassword?id='+id);
