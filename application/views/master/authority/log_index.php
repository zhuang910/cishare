		...
		<div>
			...
			<ul class="nav nav-tabs" style="padding-top:3px;padding-left:5px;">
				   <li <?php if(empty($label_id) || $label_id =='1'):?> class="active"<?php endif;?>>
                    <a href="/master/authority/log/index?label_id=1"><h5>帐号管理</h5></a>
                    </li>
					<li <?php if(!empty($label_id) && $label_id =='2'):?> class="active"<?php endif;?>>
                    <a href="/master/authority/log/index?&label_id=2"><h5>申请处理</h5></a>
                    </li>
					<li <?php if(!empty($label_id) && $label_id =='3'):?> class="active" <?php endif;?>>
                    <a href="/master/authority/log/index?&label_id=3"><h5>接机处理</h5></a>
                    </li>
					<li <?php if(!empty($label_id) && $label_id =='4'):?> class="active"<?php endif;?>>
                    <a href="/master/authority/log/index?&label_id=4"><h5>住宿处理</h5></a>
                    </li>
					<li <?php if(!empty($label_id) && $label_id =='6'):?> class="active"<?php endif;?>>
                    <a href="/master/authority/log/index?&label_id=6"><h5>凭据处理</h5></a>
                    </li>
...
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/authority/log/index?label_id=<?=$label_id?>";
		}
...
pub_alert_confirm('/master/authority/log/del_log?type='+type);
} 
