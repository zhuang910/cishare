...
<script type="text/javascript">
	...
	function add(){
		window.location.href='/master/authority/agency/add';
	}
</script>
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "/master/authority/agency/index";
		}
...
function del(id){
	pub_alert_confirm('/master/authority/agency/del?id='+id);
}

function upstate(id,state){
	pub_alert_confirm('/master/authority/agency/upstate?id='+id+'&state='+state);
	
}

function uppassword(id){
	pub_alert_confirm('/master/authority/agency/uppassword?id='+id);
