...
<div class="modal fade">
  <div class="modal-dialog">
   <div class="modal-content">
	...
	<form action="/master/cms/column/save" method="post" id="myform"  role="form" class="form-horizontal">
		 ...
		 <div class="control-group">
			...
			<div class="checkbox">
				<label>
					<input type="checkbox" class="ace" name="form-field-checkbox" value="/master/cms/column/index">
