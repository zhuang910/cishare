		...
		<div>
			...
			<div class="step-content pos-rel" id="step-container">
				<div class="step-pane active" id="step1">
					...
					<form class="form-horizontal" id="validation-form" method="post" action="/master/authority/personal/savepassword" enctype = 'multipart/form-data'>
...
$(document).ready(function(){
	$('#validation-form').validate({
					...
					rules: {
						old: {
							required: true,
							remote:'/master/authority/personal/checkpassword?id=<?=!empty($id)?$id:''?>'
						},
						password: {
							required: true
						},
