		...
		<div>
			...
			<div class="step-content pos-rel" id="step-container">
				<div class="step-pane active" id="step1">
					...
					<form class="form-horizontal" id="validation-form" method="post" action="/master/authority/admin/save" enctype = 'multipart/form-data'>
...
$(document).ready(function(){
	$('#validation-form').validate({
					...
					rules: {
						...
						username: {
							required: true,
							remote:'/master/authority/admin/checkusername?id=<?=!empty($info->id)?$info->id:''?>'
						},
						email: {
							required: true,
							remote:'/master/authority/admin/checkemail?id=<?=!empty($info->id)?$info->id:''?>'
						},
						mobile: {
							required: true
						},
