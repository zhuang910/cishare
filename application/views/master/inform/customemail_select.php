			...
			<form class="form-horizontal" id="mail-form" method="post">
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" id="title" name="title" value="<?=$info->title?>" class="col-xs-12 col-sm-5" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" id="reply_to" name="reply_to" value="<?=$info->reply_to?>" class="col-xs-12 col-sm-5" />
						</div>
					</div>
				</div>
				<div class="space-2"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<div class="inline">
							<input type="text" name="sentto" id="form-field-tags" value="<?=$info->sentto?>" placeholder="Enter tags ..." />
						</div>
