...
<ul class="breadcrumb">
	...
	<li><a href="javascript:;">自定义发送</a></li>
	...
	<div class="col-xs-12">
		...
		<div>
			...
			<form class="form-horizontal" id="mail-form" method="post">
				...
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">回复到:</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<div class="inline">
							<input type="text" name="sentto" id="form-field-tags" value="<?=$emailstr?>"  placeholder="请输入收件人" />
						</div>
				...
				<div class="col-md-offset-3 col-md-9">
					<a id='tijiao' onclick="send_email()" class="btn btn-info" data-last="Finish">
...
function send_email(){
	...
	$.ajax({
		...
		url: '/master/student/student/insert_email',
		type: 'POST',
		dataType: 'json',
