			...
			<div class="widget-body">
				<div class="widget-body-inner" style="display: block;">
					<div class="widget-main" style="height: 230px">
						<form target="_blank" class="form-horizontal" id="validation-form" method="post" action="/master/pub_print/sdyinc_print/student_offer" enctype = 'multipart/form-data'>
						...
						<div class="form-group">
								...
								<div class="form-group">
									<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">离校时间:</label>
