...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-header">
			分类管理
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加" type="button" href="/master/category/category/add" style="float:right;">
...
<script type="text/javascript">
	function del(id){
		pub_alert_confirm('/master/category/category/del?id='+id);
	}
</script>
...
<script type="text/javascript">
	...
	if($('#sample-table-2').length > 0){
		...
		$("#sample-table-2").dataTable({
            ...
            "bServerSide":true,
            "bStateSave":true,
            "sAjaxSource":'<?=$zjjp?>category/category',
...
function submit(){
	...
	$.ajax({
		url: "<?=$zjjp?>category/category/addqm",
		type: 'POST',
		dataType: 'json',
		data: data
	})
	.done(function(r) {
		if(r.state==1){
			window.location.href="<?=$zjjp?>category/category";
