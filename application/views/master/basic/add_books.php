					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="widget-header">
								<h5 class="widget-title"><?=$title_h3?>书籍</h5>
							...
							<form class="form-horizontal" id="validation-form" method="post" action="<?=$zjjp?>books/<?=$form_action?>">
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">书籍名称(汉语):</label>
						...
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">书籍名称(英文):</label>
						...
						<div class="space-2"></div>
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">单价(RMB):</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" id="price" name="price" value="<?=!empty($info) ? $info->price : ''?>" class="col-xs-12 col-sm-5" />
								</div>
							</div>
						</div>
						<div class="space-2"></div>
	...
	$('#validation-form').validate({
		...
		submitHandler: function (form) {
			...
			.done(function(r) {
				if(r.state==1){
					pub_alert_success();
					window.location.href="<?=$zjjp?>books";
				}else{
