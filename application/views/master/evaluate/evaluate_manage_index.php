								...
								<form id="checked" method="post" onSubmit="return derive()" action="<?=$zjjp?>student/student/derive_part">
									<!-- <div class="dataTables_borderWrap"> -->
										...
										<ul class="nav nav-tabs" style="padding-top:3px;padding-left:5px;">
											...
											<a href="/master/evaluate/evaluate_manage/index?&label_id=1"><h5>已完成</h5></a>
											</li>
											<li <?php if(!empty($label_id) && $label_id =='2'):?> class="active"<?php endif;?>>
											<a href="/master/evaluate/evaluate_manage/index?&label_id=2"><h5>未完成</h5></a>
											</li>
...
function input(id,h){
	...
	if($('#sample-table-2').length > 0){
		...
		$("#sample-table-2").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource":'<?=$zjjp?>evaluate_manage?label_id=<?=$label_id?>',
