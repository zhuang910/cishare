	...
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
				<div class="table-header">
					评教项列表
					<button style="float:right;" onclick="pub_alert_html('/master/evaluate/evaluate_item/add?classid=<?=$classid?>&s=1')" class="btn btn-primary btn-sm btn-default btn-sm" title="添加教室" type="button">
...
<script type="text/javascript">
	...
	$('#sample-table-2').each(function(){
		...
		if($(this).hasClass("dataTable-ajax")){
			...
			opt.sAjaxSource = "<?=$zjjp?>evaluate_item?classid=<?=$classid?>";
		}
...
function del(id){
pub_alert_confirm('/master/evaluate/evaluate_item/del?id='+id);
