	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="widget-header">
				<h5 class="widget-title">设置评教开始/截止时间</h5>
			...
			<div class="widget-body">
				<div class="widget-body-inner" style="display: block;">
					<div class="widget-main" style="height: 230px">
						<form class="form-horizontal" id="validation-form" method="post" action="/master/evaluate/evaluate_set/save_time" enctype = 'multipart/form-data'>
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">评教开始时间:</label>

							<div class="col-xs-12 col-sm-4">
								<div class="input-group">
									<input type="text" data-date-language='zh-CN' data-date-format="yyyy-mm-dd" id="starttime" class="date-picker" name="starttime" value="">
...
function save_time(){
	...
	.done(function(r) {
		if(r.state==1){
			pub_alert_success();
			window.location.href="/master/evaluate/evaluate_set";
		}
	})
	.fail(function() {
		console.log("error");
