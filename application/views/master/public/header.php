			...
			<div class="navbar-container" id="navbar-container">
					...
					<?php }?>
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?=!empty($_SESSION['master_user_info']->image) ? $_SESSION['master_user_info']->image : RES.'master/avatars/avatar2.png'?>" />
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="/master/authority/personal/profile">
								...
								<li>
									<a href="/master/authority/personal/password">
								...
								<li>
									<a href="/master/core/login/logout">
				...
				<script type="text/javascript">
					function language(v,url){
						...
						$.ajax({
							url: '/master/authority/personal/set_language?v='+v,
							type: 'GET',
							dataType: 'json',
							data: {},
						})
				...
				<?php $this->load->view('master/public/navigation/settings_basic');?>
				<!-- /section:basics/navbar.dropdown -->
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<script type="text/javascript">
						...
						function jumpmaster(){
							window.location.href="/master/core/index";
						}
