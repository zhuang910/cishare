...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="table-header">
			分类管理
			<a class="btn btn-primary btn-sm btn-default btn-sm" title="添加" type="button" href="/master/article/category/add" style="float:right;">
...
<script type="text/javascript">
	function del(id){
		pub_alert_confirm('/master/article/category/del?id='+id);
	}
</script>
...
function submit(){
	...
	$.ajax({
		url: "<?=$zjjp?>article/category/addqm",
		type: 'POST',
		dataType: 'json',
		data: data
	})
	.done(function(r) {
		if(r.state==1){
			window.location.href="<?=$zjjp?>article/category";
