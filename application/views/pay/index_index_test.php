...
<div class="BuyMain">
    ...
    <div class="BuyMenu">
        <ul>
            ...
            <li class="none BuySelect"><span>Remittance</span></li>
    ...
    <div class="BuyBox">
        <div class="yrhide" style="display: none;">
        ...
        <div class="BuyWU ythide" style="display: block;">
            <form method="post" name="myform" action="/pay/remittance/westernunion" id="myform" enctype="multipart/form-data">
            <div class="BuyCost">You need to pay: <span>USD <?=!empty($m_usd)?$m_usd:''?> (RMB <?=!empty($m_rmb)?$m_rmb:''?>)</span></div>
            <div class="BuyAcc">
                <h2 style="background:none;">Recipient's information:</h2>
               <table class="BuyAccTab">
                    ...
                    <tr>
                       <th>Account: </th>
                       <td>19-030101040006801（RMB）
                            19030114040001011（US Dollars）
                            19030138040000483（Euros）
                        </td>
                    </tr>
                    <tr>
                       <th>Bank: </th>
                       <td>Agricultural Bank of China, Hangzhou Baochu Sub-Branch）
                        </td>
                    </tr>
                     <tr>
                       <th>Swift Code: </th>
                      ...
                      <tr>
                       <th>Add: </th>
                       <td>No.122, Shuguang Road, Hangzhou, China
                        </td>
                    </tr>
                    <tr>
                       <th>Phone: </th>
                       <td> 0086 571 85774115
                        </td>
                    </tr>
                    <tr >
                       <th style="color:red">Tips: </th>
                       <td style="color:red"> Please fill in the details of remittance use
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="margin-top:10px;">
             <ul>
                <li class="mg_b_20" style="clear:both;">
                  <input type="text" value="Sender Name" class="hideinputone tongyong width_322" onfocus="$('.hideinput').show();$(this).hide();$('.hideinput').focus();"/>
                  <input class="tongyong width_322 hideinput"style="display:none;" onfocus="if(this.value=='Sender Name'){this.value='';};" onblur="if(this.value==''||this.value=='Sender Name'){this.value='';$('.hideinputone').show();$('.hideinput').hide();}" id="remit_name" name="remit_name" validate="required:true" >
                  <div class="sign-up-right"></div>
                </li>
                 <li class="mg_b_20" style="clear:both;">
                    <select validate="required:true" style="width:168px;" id="remit_nationality" name="remit_nationality">
                ...
                <li class="mg_b_20" style="clear:both;">
                  <input type="text" value="Money remitter" class="hideinputtwo tongyong width_322" onfocus="$('.hideinput2').show();$(this).hide();$('.hideinput2').focus();"/>
                  <input class="tongyong width_322 hideinput2"style="display:none;" onfocus="if(this.value=='Money remitter'){this.value='';};" onblur="if(this.value==''||this.value=='Money remitter'){this.value='';$('.hideinputtwo').show();$('.hideinput2').hide();}" id="remit_money" name="remit_money" validate="required:true" >
                  <div class="sign-up-right"></div>
                </li>
                <li class="mg_b_20" style="clear:both;">
                  <input type="text" value="Student Name" class="hideinputtree tongyong width_322" onfocus="$('.hideinput3').show();$(this).hide();$('.hideinput3').focus();"/>
                  <input class="tongyong width_322 hideinput3"style="display:none;" onfocus="if(this.value=='Student Name'){this.value='';};" onblur="if(this.value==''||this.value=='Student Name'){this.value='';$('.hideinputtree').show();$('.hideinput3').hide();}" id="student_name" name="student_name" validate="required:true" >
                  <div class="sign-up-right"></div>
                </li> 
            </div> 
            <div style="margin-top:5px; clear:both;">
             <li class="mg_b_20" style="clear:both;">
               <textarea style="width:300px;height:200px;margin-top:10px;" class="hideinputfour tongyong width_322" onfocus="$('.hideinput4').show();$(this).hide();$('.hideinput4').focus();">Remittance Remark</textarea>
               <textarea  onfocus="if(this.value=='Remittance Remark'){this.value='';};" onblur="if(this.value==''||this.value=='Remittance Remark'){this.value='';$('.hideinputfour').show();$('.hideinput4').hide();}" class="hideinput4" validate="required:true" id="remit_remark" name="remit_remark" style="display:none;width:300px;height:200px;margin-top:10px;"></textarea>
             </li>
             </ul>
             
            </div>
            <div class="BuyXing" style="padding-top:20px;clear:both">
                <dl>
                <dt>ZUST recommends applicants who are inconvient with T/T or PayPal payments use Western Union (especially African applicants).</dt>
                    ...
                    <dd>Please upload the photocopy of your receipt with MTCN in time to make sure ZUST confirm your payment.</dd>
                </dl>
            </div>
        ...
        <form method="post" action="/pay/remittance/abroad" id="form-abroad" enctype="multipart/form-data">
            ...
            <div class="BuyXing" style="padding-top:20px;">
                ...
                <dt>Applicants overseas can use bank transfer to pay the application fee in US Dollars.</dt>
                    ...
                    <dd>Please upload the photocopy of your bank receipt to make sure ZUST could confirm your payment. It usually takes 2-3 weeks for the banking system to confirm an overseas payment. Please wait patiently.</dd>
                </dl>
            </div>
            <input type="hidden" name="key" value="<?=!empty($order_info['ordernumber'])?$order_info['ordernumber']:''?>">
             <input type="hidden" name="orderid" value="<?=!empty($order_info['id'])?$order_info['id']:''?>">
        ...
        <form method="post" action="/pay/remittance/internal" id="form-internal" enctype="multipart/form-data">
            ...
            <div class="BuyXing" style="padding-top:20px;">
                ...
                <dt>Applicants in China can use a direct bank transfer to pay the application fee in RMB.</dt>
                    ...
                    <dd>Please upload the photocopy of your bank receipt to make sure ZUST  could confirm your payment. It usually takes 2-3 working days for the banking system to confirm the payment. </dd>
                </dl>
            </div>
            <input type="hidden" name="key" value="<?=!empty($order_info['ordernumber'])?$order_info['ordernumber']:''?>">
            <input type="hidden" name="orderid" value="<?=!empty($order_info['id'])?$order_info['id']:''?>">
    ...
    <div class="alert alert-success">
        ...
        <ul>
          <li><strong>Amount:</strong> RMB <?=!empty($m_rmb)?$m_rmb:''?></li>
          <li><strong>Payment method:</strong> Remittance</li>
          ...
          Please wait for 1-2 working days for ZUST to verify your payment receipt. (An e-mail contains verification result will be sent to you.) Then you can access your application and click on the 'Submit' button to send your application to the university online.
          </span></li>
        </ul>
        <script type="text/javascript">
			var url = '/<?=$puri?>/student/apply/make_paymeznt?applyid=<?=cucas_base64_encode($order_info['applyid'])?>';
                $(function(){
                    setTimeout("location.href='/<?=$puri?>/student/apply/make_paymeznt?applyid=<?=cucas_base64_encode($order_info['applyid'])?>'",10000)
                });
        </script>
    </div>
    <?php }?>
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" id="paypal">
    ...
    <INPUT TYPE="hidden" name="charset" value="utf-8">
    <input type="hidden" name="bn" value="PP-BuyNowBF:btn_buynowCC_LG.gif:NonHosted">
    <input type="hidden" name="return" value="http://<?=$nowurl?>/student/apply/make_paymzent?applyid=<?=cucas_base64_encode($order_info['applyid'])?>" />
</form>
-->
<!-- payease -->
