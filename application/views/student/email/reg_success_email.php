...
*/
?>
<?php  $this->load->view('student/email/studentemail_header.php')?>
    ...
    <td><table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <table width="550" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="line-height:25px; font-size:14px; color:#444;">Your account has been successfully activated. </td>
              </tr>
            </table>
           </td>
        </tr>
		<tr>
          ...
          <table width="510" border="0" align="center" cellpadding="0" cellspacing="0">            
              <tr>
				...
				<p><strong>Please refer the following link to active your account.</strong></p>
				<p><a href="<?=$url?>" target="_blank">Active Account</a></p>
       ...
       <!-- <tr>
          ...
          <table width="510" border="0" align="center" cellpadding="0" cellspacing="0">            
              <tr>
                <td width="510" style="padding:10px 0px;line-height:25px; font-size:14px; color:#444;">
				Now, you can begin to find yourself a suitable program as well as a Chinese university.
					Simply click the '<a href="http://www.cucas.edu.cn/">Find a Course</a>' to start the first step in your application.
				</td>
              </tr>
            </table>
         </td>
...
<?php  $this->load->view('student/email/studentemail_footer.php')?>