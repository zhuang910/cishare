...
<div class="width_925">
  ...
  <div class="center_geren">
    <div class="xiugaimima">
     <form class="form-signin" role="form"  id="myform" name="myform" action="/student/student/do_editpassword" method="post">
      <ul>
