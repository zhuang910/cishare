          ...
          <tr>
            ...
            <?php foreach($course_info as $k=>$v){?>
                <tr>
                  ...
                  <td align="left"><a href="javascript:;"> <?=$puri=='cn'?(!empty($v['rname'])?$v['rname']:''):(!empty($v['renname'])?$v['renname']:'')?></td></a></td>
                  <td align="left"><a href="javascript:;"><?=lang('electives_week'.$v['week'])?> <?=$v['knob']?><?=lang('electives_knob')?></a></td>
                  <td align="left"><a href="javascript:;" onclick="look_remark(<?=$v['id']?>)"><?=lang('acc_ckbz')?></a>&nbsp;&nbsp;<a href="javascript:;" style="color:red" onclick="delete_course(<?=$v['id']?>)"><?=lang('electives_chexiao')?></a></td>
                </tr>
          <?php }?>
        </table>
        <?php }else{?>
...
function look_remark(id){
    var d = top.dialog({
        ...
        cancel:true,
        fixed:true,
        url:'/<?=$puri?>/student/electives/look_remark?id='+id
    });
    d.show();
  }
</script>
