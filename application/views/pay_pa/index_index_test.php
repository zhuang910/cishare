...
<div class="BuyMain">
    ...
    <div class="BuyMenu">
        <ul>
            ...
            <?php if(!empty($item_type) && ($item_type == 1 || $item_type == 6||$item_type == 4||$item_type == 5)){?>
    ...
    <div class="BuyBox">
        ...
        <div class="BuyWU ythide" style="display: block;">
            <form method="post" action="/pay/remittance/westernunion" name="myform" id="myform" enctype="multipart/form-data">
            <div class="BuyCost">You need to pay: <span>USD <?=!empty($m_usd)?$m_usd:''?> (RMB <?=!empty($m_rmb)?$m_rmb:''?>)</span></div>
            <div class="BuyAcc">
                <h1>Recipient's information:</h2>
            ...
            <div class="BuyXing" style=" margin-top:20px; clear:both">
                <dl>
    ...
    <div class="alert alert-success">
        ...
        <script type="text/javascript">
			var url = '/<?=$puri?>/student/student/tuition';
                $(function(){
                    setTimeout("location.href='/<?=$puri?>/student/student/fee'",10000)
                });
        </script>
    </div>
    <?php }?>
