...
class Zjj extends CUCAS_Ext {
	...
	function up(){
		$this->load->view ( 'admin/core/grf.php');
	}
// 	function do_up(){
// 			$config = array (
// 				'save_path' => zhuangqianlin_ROOT.'/resource/public',
...
// 				$b=zhuangqianlin_ROOT.'/resource/public/'.$_FILES['file']['name'];
// 				$this->unzip_file(zhuangqianlin_ROOT.'/resource/public/'.$_FILES['file']['name'],JJ_ROOT.'/resource/public/');
// 				echo $b;
