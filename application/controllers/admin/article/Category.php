 ...
 * @desc 2016-05-28
 */
class Category extends Admin_Basic {
    protected $_size = 3;
    protected $_count = 0;
    ...
    function index() {
        ...
        if ($this->input->is_ajax_request () === true) {
            ...
            foreach ( $output ['aaData'] as $item ) {
                ...
                $item->operation = '<div class="btn-group"><a class="btn btn-xs btn-info" href="' . $this->access_path . 'article/category' . '/edit?id=' . $item->cat_id . '">编辑</a><button data-toggle="dropdown" class="btn btn-xs btn-info btn-white dropdown-toggle">
								更多
