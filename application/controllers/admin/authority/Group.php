 ...
 *        
 */
class Group extends Admin_Basic {
	...
	function index() {
		...
		if ($this->input->is_ajax_request () === true) {
			...
			foreach ( $output ['aaData'] as $item ) {
				...
				$item->operation = '
					<a href="/admin/authority/group/add?id=' . $item->id . '" class="btn btn-xs btn-info" >编辑</a>
					
				';
				
				$item->operation .= '<a href="/admin/authority/group/power?id=' . $item->id . '" class="btn btn-xs btn-info btn-white">授权</a>';
			}
