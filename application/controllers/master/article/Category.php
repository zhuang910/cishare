    ...
    function index() {
        ...
        if ($this->input->is_ajax_request () === true) {
            ...
            foreach ( $output ['aaData'] as $item ) {
                ...
                $item->operation = '<div class="btn-group"><a class="btn btn-xs btn-info" href="' . $this->zjjp . 'article/category' . '/edit?id=' . $item->cat_id . '">编辑</a><button data-toggle="dropdown" class="btn btn-xs btn-info btn-white dropdown-toggle">
								更多
