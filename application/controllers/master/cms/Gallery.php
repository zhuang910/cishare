 ...
 *        
 */
class Gallery extends Master_Basic {
	/**
	 * PPT管理
	 *
	 * @var array
	...
	function index() {
		...
		if ($this->input->is_ajax_request () === true) {
			...
			foreach ( $output ['aaData'] as $item ) {
				...
				$item->operation = '<a title="编辑" class="blue" href="/master/cms/gallery/editgallery?columnid=' . $item->columnid . '&_id=' . $item->id . '">
		...
		$this->_view ( 'gallery_index', array (
				'columnid' => $columnid 
		) );
	}
