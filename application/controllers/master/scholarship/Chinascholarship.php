 ...
 *        
 */
class Chinascholarship extends Master_Basic {
...
// 		}
		$where = 'applyscholarship_info.type = 3 AND applyscholarship_info.state = ' . $label_id . '';
		// 根据状态获得申请列表信息
		...
		$this->load->view ( 'master/scholarship/chinascholarship_index', $data );
	}
