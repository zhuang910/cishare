 ...
 *        
 */
class Send_book_Model extends CI_Model {
	...
	function get($field, $condition) {
		if (is_array ( $field ) && ! empty ( $field )) {
			...
			$this->db->select ('student.id as id,student.userid as userid,student.name as name,student.enname as enname,student.passport as passport,squad.nowterm as nowterm,student.majorid as majorid');
